...
if (isset($_POST["submit"])){
  ...
  $nomph = mysqli_real_escape_string($conn, $nomph);
  
  $duplicate = mysqli_query($conn, " SELECT * FROM `pharmacien` WHERE `username` = '$username' ");
  if(mysqli_num_rows($duplicate)>0){
    echo "<script> alert('nom d'utilisateur ou e-mail a déjà pris'); </script>";
  }
    else{
      if($password == $confirmpassword){
        $query = "INSERT INTO `pharmacien`(username,password,nom,prenom,adresse,email,num_tel,nom_pharmacie,longitude,latitude,pharmacie_activé,état) VALUES('$username','$password','$nom','$prenom','$address','$email','$num_tele','$nomph','$long','$lati','1','en attente')";
  ...
  <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <u class="text-black">S'inscrire</u>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-5 text-black">S'inscrire comme Pharmacien</h2>
          </div>
          <div class="col-md-12">
              ...
              <div class="p-6 p-lg-5 ">
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <input name ="username" type="text" class="form-control"style="margin-left:11%;width:800px;">
                  </div>
                  <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                    ...
                    <input name="nom" type="text" class="form-control"style="margin-left:11%;width:800px;">
                  </div>
                  <div class="col-md-12">
                    <label for="c_lname" class="text-black"style="margin-left:11%;width:800px;">Prénom</label>
                    <input name="prenom" type="text" class="form-control"style="margin-left:11%;width:800px;">
                  </div>
                  <div class="col-md-12">
                    <label for="c_lname" class="text-black"style="margin-left:11%;width:800px;">Adresse</label>
                    <input name="adresse" type="text" class="form-control"style="margin-left:11%;width:800px;">
                  </div>
                  <div class="col-md-12">
                    <label for="c_lname" class="text-black"style="margin-left:11%;width:800px;">Email</label>
                    <input name="email" type="email" class="form-control"style="margin-left:11%;width:800px;">
                  </div>
                  <div class="col-md-12">
                    <label for="c_lname" class="text-black"style="margin-left:11%;width:800px;">Num de téléphone</label>
                    <input name="num_tel" type="text" class="form-control"style="margin-left:11%;width:800px;">
                  </div>
                  <div class="col-md-12">
                    <label for="c_lname" class="text-black"style="margin-left:11%;width:800px;">Nom de votre pharmacie</label>
                    <input name="nomph" type="text" class="form-control"style="margin-left:11%;width:800px;">
                  </div>
                  <div class="col-md-12">
                    <label for="c_lname" class="text-black"style="margin-left:11%;width:800px;">Longitude de votre pharmacie</label>
                    <input name="long" type="text" class="form-control"style="margin-left:11%;width:800px;">
                  </div>
                  <div class="col-md-12">
                    <label for="c_lname" class="text-black"style="margin-left:11%;width:800px;">Latitude de votre pharmacie</label>
                    <input name="lati" type="text" class="form-control"style="margin-left:11%;width:800px;">
                  </div>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-lg-12">
                  <input type="submit" name ='submit' class=" btn-lg btn-block"style="margin-left:30%;width: 450px;" value="S'inscrire">
                </div>
              </div>
            </form>
          </div>
